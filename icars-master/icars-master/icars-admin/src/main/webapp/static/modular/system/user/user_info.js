...
UserInfoDlg.openAddLngLat = function () {
...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('password').set('avatar')
        .set('email').set('name').set('birthday').set('rePassword').set('deptid').set('phone').set('lng').set('lat').set('sfkf').set('black_flag');

    if($('#city').text() && $('#province').text() && $('#district').text()){
        this.userInfoData['province'] = $('#province').text()
        this.userInfoData['city'] = $('#city').text();
        this.userInfoData['area'] = $('#district').text();
    }
};
 ...
 * 验证是否选择省市区
 */
UserInfoDlg.validateAddress = function () {
    var province = $('#province').text();
    var city = $('#city').text();
    var area = $('#district').text();
...
$(function () {
    ...
    $("#sfkf").val($("#sfkfValue").val());
     $("#black_flag").val($("#black_flagValue").val());
