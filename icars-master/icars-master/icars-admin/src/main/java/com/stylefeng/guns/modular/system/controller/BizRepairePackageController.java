 ...
 */
@Controller
@RequestMapping("/bizRepairePackage")
public class BizRepairePackageController extends BaseController {

    private String PREFIX = "/system/bizRepairePackage/";
    ...
    @RequestMapping("")
    public String index() {
        return PREFIX + "bizRepairePackage.html";
    }

    /**
     * 跳转到添加
     */
    @RequestMapping("/bizRepairePackage_add")
    public String bizRepairePackageAdd() {
        return PREFIX + "bizRepairePackage_add.html";
    }

    /**
     * 跳转到修改
     */
    @RequestMapping("/bizRepairePackage_update/{bizRepairePackageId}")
    public String bizMaintainPackageUpdate(@PathVariable Integer bizRepairePackageId, Model model) {
        BizMaintainPackage bizMaintainPackage = bizMaintainPackageService.selectById(bizRepairePackageId);
        ...
        return PREFIX + "bizRepairePackage_edit.html";
    }
    ...
    @ResponseBody
    public Object delete(@RequestParam Integer bizRepairePackageId) {
        bizMaintainPackageService.deleteById(bizRepairePackageId);
        return SUCCESS_TIP;
    }
    ...
    @ResponseBody
    public Object onShowOrOffShow(@RequestParam Integer bizRepairePackageId) {
        BizMaintainPackage bizMaintainPackage = bizMaintainPackageService.selectById(bizRepairePackageId);
    ...
    @BussinessLog(value = "修改维修套餐", key = "packageName", dict = BizMaintainPackageDict.class)
    @ResponseBody
     ...
     * 详情
     */
    @RequestMapping(value = "/detail/{bizRepairePackageId}")
    @ResponseBody
    public Object detail(@PathVariable("bizRepairePackageId") Integer bizRepairePackageId) {
        return bizMaintainPackageService.selectById(bizRepairePackageId);
    }
}
