package com.cheji.b.utils;

import com.cheji.b.pojo.WxPayNotifyPojo;
...
public class WeChatUtils {
     ...
     * @return xml字符串
     */
    public static String sendDataToXml(WxPayNotifyPojo data) {
        xStream.autodetectAnnotations(true);
        xStream.alias("xml", WxPayNotifyPojo.class);
