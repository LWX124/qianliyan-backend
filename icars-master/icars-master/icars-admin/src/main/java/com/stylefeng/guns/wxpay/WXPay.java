...
public class WXPay {
     ...
     * 该函数适用于商户适用于企业付款到零钱接口，不适用企业付款查询
     *
     * @param reqData
     * @return
     * @throws Exception
...
//            reqData.put("sign_type", WXPayConstants.MD5);
     ...
     * @throws Exception
     */
    public Map<String, String> fillRequestDataForQuery(Map<String, String> reqData) throws Exception {
...
//           }
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respXml = this.requestWithoutCert(url, this.fillRequestDataForQuery(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
    ...
    public Map<String, String> qyPay(Map<String, String> reqData) throws Exception {
        String url;
        url = WXPayConstants.MMPAYMKTTRANSFERS_PROMOTION_TRANSFERS;
        String respXml = this.requestWithCert(url, this.fillRequestData(reqData), this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml);
    }

    public Map<String, String> qyWxRedBagPay(Map<String, String> reqData) throws Exception {
        String url;
        url = WXPayConstants.MMPAYMKTTRANSFERS_PROMOTION_TOREDBAG;
        String respXml = this.requestWithCert(url, reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml);
    }
    public Map<String, String> qyPayQuery(Map<String, String> reqData) throws Exception {
        String url;
        url = WXPayConstants.MMPAYMKTTRANSFERS_GETTRANSFERINFO;
        String respXml = this.requestWithCert(url, this.fillRequestDataForQuery(reqData), this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml);
    }
