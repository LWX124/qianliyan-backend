...
public class UserFactory {
    ...
    public static User editUser(UserDto newUser, User oldUser) {
        if (newUser == null || oldUser == null) {
            ...
            if (ToolUtil.isNotEmpty(newUser.getSfkf())) {
                oldUser.setSfkf(newUser.getSfkf());
            }
            ...
            if (ToolUtil.isNotEmpty(newUser.getArea())) {
                oldUser.setArea(newUser.getArea());
            }
            if (ToolUtil.isNotEmpty(newUser.getBlack_flag())) {
                oldUser.setBlack_flag(newUser.getBlack_flag());
            }
            return oldUser;
        }
    }
