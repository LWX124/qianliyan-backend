...
public class DateUtils {
    ...
    public static String formateDate(long time,String pat)
    {
        DateFormat serverDateFormat = new SimpleDateFormat(pat, Locale.ENGLISH);
        return serverDateFormat.format(time);
    }
    ...
    public static final SimpleDateFormat sm = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    public static final SimpleDateFormat sm2 = new SimpleDateFormat("yyyy-MM-dd");

    public static String getFormatDate(Date date) {
        return sm2.format(date);
    }
    ...
    public static int getSecondDifference(Date date1, Date date2) {
        ...
        int expir = getSecondTimestamp(date1) - getSecondTimestamp(date2);
        return expir;
    }
}
