...
import com.jeesite.modules.constant2.HuanxinConst;
...
public class HuanXinService {
    ...
    public String getToken() {
        ...
        stringRedisTemplate.opsForValue().set(RedisKeyUtils.HUANXIN_TOKEN, parse.getString("access_token"),
    ...
    private HttpHeaders getHeader() {
        ...
        String s = stringRedisTemplate.opsForValue().get(RedisKeyUtils.HUANXIN_TOKEN);
