...
//    String AUCATION_
    ...
    //创建一口价车辆订单 分布式锁
    String CREATE_ONE_PRICE_CAR_ORDER = "CREATE_ONE_PRICE_CAR_ORDER:";

    //一口价车辆订单多人购买时上锁(3分钟)
    String ONE_PRICE_CAR_LOCK = "ONE_PRICE_CAR_LOCK:";

    //一口价订单支付回调
    String ONE_PRICE_ORDER_STATUS = "ONE_PRICE_ORDER_STATUS:";
