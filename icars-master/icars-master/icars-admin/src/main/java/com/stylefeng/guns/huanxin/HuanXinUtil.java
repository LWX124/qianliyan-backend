package com.stylefeng.guns.huanxin;
...
public class HuanXinUtil {
    ...
    public String getToken() {
        ...
        jedisUtil.setEx(RedisKey.HUANXIN_TOKEN, parse.getString("access_token"), parse.getInteger("expires_in") - 200);
        return body;
    }
    ...
    public JSONObject singleRegister(String userName, String passWord, String nickname, boolean exceptionFlag) {
        ...
        array.add(in);
        HttpEntity<JSONArray> requestEntity = new HttpEntity<JSONArray>(array, getHeader());
        JSONObject out = null;
        try {
...
//        requestHeaders.setContentType(MediaType.APPLICATION_JSON);
        String s = jedisUtil.get(RedisKey.HUANXIN_TOKEN);
