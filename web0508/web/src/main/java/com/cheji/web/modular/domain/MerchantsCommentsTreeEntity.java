...
public class MerchantsCommentsTreeEntity extends Model<MerchantsCommentsTreeEntity> {
    ...
    @TableField(exist = false)
    private String [] commentImg;       //评论图片

    private String lable;               //评论时标签
    ...
    public String toString() {
        return "MerchantsCommentsTreeEntity{" +
                ...
                ", commentImg=" + Arrays.toString(commentImg) +
                ", lable='" + lable + '\'' +
